...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['file'])) {
        ...
        $filename = $admin_id . '_' . time() . '.' . pathinfo($file['name'], PATHINFO_EXTENSION);
    ...
    $allowed_fields = ['first_name', 'middle_name', 'last_name', 'email', 'password'];
    ...
    $query = "UPDATE admin SET $field = ? WHERE id = ?";
    $stmt = $conn->prepare($query);
